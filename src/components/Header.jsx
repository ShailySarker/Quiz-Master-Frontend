...
const Header = () => {
    return (
        <div className="sticky top-0 z-50 border-b-2 bg-white border-amber-400 xl:px-24 lg:px-16 md:px-10 px-5 xl:py-6 lg:py-[14px] md:py-4 py-[14px] flex justify-between">
